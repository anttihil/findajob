...
from findajob.profile.prompts import render_job_context, render_resume_plaintext
...
@patch("findajob.profile.screener.invoke_structured")
@patch("findajob.profile.screener.structured_model")
