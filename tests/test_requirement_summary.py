...
def core(requirement: str, importance: str = "must_have", quote: str = "quoted") -> dict[str, Any]:
    return {"requirement": requirement, "importance": importance, "quote": quote}


def assessed(requirement: str, status: str, evidence: str | None = None) -> dict[str, Any]:
    return {"requirement": requirement, "status": status, "candidate_evidence": evidence}


class RequirementSummaryTests(unittest.TestCase):
    def test_counts_only_must_haves(self) -> None:
    ...
    def test_partial_is_not_folded_into_met(self) -> None:
        summary = _requirement_summary(
    ...
    def test_the_join_matches_the_validator_normalisation(self) -> None:
    ...
    def test_an_unassessed_must_have_is_reported_not_dropped(self) -> None:
    ...
    def test_a_row_without_extraction_summarises_to_nothing(self) -> None:
    ...
    def test_a_posting_with_no_must_haves_summarises_to_nothing(self) -> None:
        self.assertIsNone(
            _requirement_summary([core("Kafka", "nice_to_have")], [assessed("Kafka", "met")])
        )
